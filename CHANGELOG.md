# qbic-pipelines/vcftomat: Changelog
...
- [#24](https://github.com/qbic-pipelines/vcftomat/pull/24) - Change branching logic to enable caching again + rename vcf2mat to vcf2counts
