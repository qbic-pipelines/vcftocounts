...
**qbic-pipelines/vcftocounts** is a bioinformatics pipeline that ...
...
<!-- If you use qbic-pipelines/vcftocounts for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
